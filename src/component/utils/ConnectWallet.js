...
export default function ConnectWallet({ modalWallet, setModalWallet, provider, connect, onLoadTwo, }) {
  ...
  useEffect(() => {
    ...
    return (
        <div className="bg-[#000] absolute top-[63px] right-[68px] h-[110px] border-[#690069] rounded-[8px] flex flex-col p-[20px] gap-[23px]" ref={myRef} >
            <div className="text-sm text-white flex justify-start items-center gap-[5px]" style={{cursor: 'pointer'}} onClick={() => connect(provider)}>
             <svg viewBox="0 0 28 28" width={28} height={28} fill="none" xmlns="http://www.w3.org/2000/svg" className="css-1whn15r rounded-[5px]" >
             ...
             <div className="text-sm text-white flex justify-start items-center gap-[5px]" style={{cursor: 'pointer'}} onClick={onLoadTwo}>
             <svg viewBox="0 0 28 28" width={28} height={28} fill="none" xmlns="http://www.w3.org/2000/svg" className="css-1whn15r rounded-[5px]" >
